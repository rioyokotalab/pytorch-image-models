...
python train_with_wds.py /groups/gca50014/Fractal/edRender/x256/FractalDB-1000_PATCHGR \
    --model deit_base_patch16_224 --experiment pretrain_deit_base_MVfractal300k_256gpus_shards \
    --sched cosine_iter --epochs 7 --lr 1.0e-3 --weight-decay 0.05 \
    --batch-size 32 --opt adamw --num-classes 300000 \
