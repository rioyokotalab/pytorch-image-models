...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_voc12_mvf21k_$JOB_ID.out
...
python train.py /groups/gcd50691/datasets/voc12 \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_voc12_${DATA}${CLASSES}k \
    --input-size 3 224 224 --num-classes 20 \
...
#    --resume ${OUT_DIR}/finetune_deit_${MODEL}_voc12_${DATA}${CLASSES}k/last.pth.tar
