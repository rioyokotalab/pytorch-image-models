...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_p30_mvf21k_$JOB_ID.out
...
python train.py /groups/gcd50691/datasets/places30 \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_p30_${DATA}${CLASSES}k \
    --input-size 3 224 224 --num-classes 30 \
...
#    --resume ${OUT_DIR}/finetune_deit_${MODEL}_p30_${DATA}${CLASSES}k/last.pth.tar
