...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_mnist_mvf21k_$JOB_ID.out
...
python train.py /groups/gcd50691/datasets/MNIST \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_mnist_${DATA}${CLASSES}k \
