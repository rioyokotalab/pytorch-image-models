...
python train_linear.py /groups/gcc50533/imnet/ILSVRC2012 \
    --model deit_tiny_patch16_224 --experiment pretrain_deit_tiny_imnet_linear_test \
    --input-size 3 224 224 --num-classes 1000 \
    --sched linear --epochs 1 --lr 0.001 --weight-decay 0.05 \
