...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_kmnist_mvf21k_$JOB_ID.out
...
python train.py /groups/gcd50691/datasets/KMNIST \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_kmnist_${DATA}${CLASSES}k \
