...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_imnet1per_mvf21k_$JOB_ID.out
...
# python train.py /groups/gcd50691/datasets \
#     --train-split ImageNet_${PERCENT}percent/train --val-split ImageNet/val \
#     --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_imnet${PERCENT}per_${DATA}${CLASSES}k \
#     --input-size 3 224 224 --num-classes 1000 \
#     --sched cosine_iter --epochs 1000 --lr 0.001 --weight-decay 0.0001 \
...
python train.py /groups/gcd50691/datasets \
    --train-split ImageNet_${PERCENT}percent/train --val-split ImageNet/val \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_imnet${PERCENT}per_${DATA}${CLASSES}k_1kpara_1000epoch_bs512 \
    --input-size 3 224 224 --num-classes 1000 \
    --sched cosine_iter --epochs 1000 --lr 0.0005 --weight-decay 0.05 \
