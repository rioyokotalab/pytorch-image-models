...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_im100_mvf21k_$JOB_ID.out
...
python train.py /groups/gcd50691/datasets/imagenet100 \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_im100_${DATA}${CLASSES}k \
...
#    --resume ${OUT_DIR}/finetune_deit_${MODEL}_im100_${DATA}${CLASSES}k/last.pth.tar
