...
python train.py /groups/gca50014/imnet/ILSVRC2012 \
    --model deit_base_patch16_224 --experiment finetune_deit_base_imnet_fractal10k_100epoch \
    ...
    -j 32 --pretrained-path /groups/gcc50533/acc12016yi/pytorch-image-models/output/train/pretrain_deit_base_fractal10k_128gpus_cooldown_100/last.pth.tar \
