...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_v07_mvf21k_$JOB_ID.out
...
python train.py /groups/gcd50691/datasets/PASCALVOC2007 \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_v07_${DATA}${CLASSES}k \
