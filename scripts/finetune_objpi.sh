...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o output/finetune_tiny_objpi_mvf21k_$JOB_ID.out
...
python train.py /groups/gcd50691/datasets/ObjectPI-pro \
    --model deit_${MODEL}_patch16_224 --experiment finetune_deit_${MODEL}_objpi_${DATA}${CLASSES}k \
    --input-size 3 224 224 --num-classes 25 \
