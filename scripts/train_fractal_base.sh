...
python train_without_eval.py /groups/gca50014/Fractal/edRender/x256/FractalDB-21000_PATCHGRAY \
    --model deit_base_patch16_224 --experiment pretrain_deit_base_fractal21k_128gpus_300epochs \
    ...
    --resume /groups/gcc50533/acc12016yi/pytorch-image-models/output/train/pretrain_deit_base_fractal21k_128gpus_300epochs/last.pth.tar \
    --log-wandb
