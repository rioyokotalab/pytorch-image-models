...
def train_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        if not mixup_active:
            ...
            target_class = target[:,:args.num_classes] + target[:,args.num_classes:]
            target_label = torch.sum(target[:,args.num_classes:], 1).unsqueeze(1) # realの方を横方法にたす([128, 1000] -> [128, 1]) 1->real, 0->fake
        ...
        with amp_autocast():
            ...
            loss = (loss_class + rate_loss*args.separate_rate*loss_label)/(1+args.separate_rate)
