...
# profiling
parser.add_argument('--profiling-path', default='./logs', type=str, metavar='PATH',
                    help='Profiling path (default: none)')
...
def train_one_epoch(
    ...
    with torch.profiler.profile(
        schedule=torch.profiler.schedule(
            ...
            warmup=2,
            active=6),
        on_trace_ready=torch.profiler.tensorboard_trace_handler(args.profiling_path),
        with_stack=True
    ) as profiler:
