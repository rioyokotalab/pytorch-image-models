...
def main():
    ...
    if args.webdataset:
        print0("\n\n=> Loading DataSet wiht WebDataset using .tars")
        ...
        if args.trainshards is not None:
            ...
            list_fn = f"MVFractal_300k_shards.txt"
            ...
            if args.rank == 0:
                _logger.info(
                    ...
                    'Data: {data_time.val:.3f} ({data_time.avg:.3f})'.format(
                        ...
                        100. * batch_idx / max(last_idx,1), # prevent division by 0(when batch size is large, last_idx become 0)
                        loss=losses_m,
