...
mpirun -n $NUM_PROC -stdout output/%j.out -stderr output/%j.err python train_cpu.py ./ \
    --pretrained-path /home/hp190122/u01959/deit_pretrained/deit_tiny_patch16_224-a1311bcf.pth \
    --dataset CIFAR10 \
    --num-classes 10 \
